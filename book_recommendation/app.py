...
st.write("Welcome to the Book Recommender System! Select a book from the dropdown below to get personalized recommendations.")
...
def get_collaborative_based_recommendations(selected_book, top_n):
    ...
    try:
        distance, suggestion = model.kneighbors(book_id.reshape(1, -1), n_neighbors=top_n)
